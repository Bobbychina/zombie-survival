...
export const POIS: Record<string, PoiDef> = {
  ...
  pharmacy: P({ id:'pharmacy', name:'药房', icon:'💊', biomes:['city','suburb'], danger:0, searches:4,
    loot:{ bandage:.45, painkiller:.3, anti:.28, fungicide:.26, medkit:.12, chem:.15, purify:.35, dirty:.2 }, enemies:['walker','crawler'],
    feat:'medical', desc:'处方柜台锁着，但后面那排货架还满着。' }),
  hospital: P({ id:'hospital', name:'医院', icon:'🏥', biomes:['city'], danger:1, searches:6,
    loot:{ bandage:.4, medkit:.2, anti:.25, fungicide:.2, painkiller:.25, chem:.2, serum:.05, purify:.3, dirty:.25 }, enemies:['walker','crawler','screamer','poison'],
  ...
  clinic: P({ id:'clinic', name:'诊所', icon:'🩺', biomes:['suburb','farm'], danger:0, searches:3,
    loot:{ bandage:.5, painkiller:.3, anti:.25, fungicide:.22, cloth:.2 }, enemies:['walker','crawler'], feat:'medical',
    desc:'社区诊所。柜子小，但没人抢过。' }),
