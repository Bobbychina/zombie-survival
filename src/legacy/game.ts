...
const ITEMS = {
  ...
  /* M66：楼门钥匙 —— 进楼搜刮时开"加固门"用（在别的房间里翻得到；没有就撬棍+材料硬撬，或者硬踹）。
     它是一次性的场景钥匙，不进主线（所以商人不收：t:'key' 的那条规则顺带覆盖了它）。 */
  roomkey:  {n:'楼门钥匙',  t:'key',   w:0.05, desc:'一串挂着小木牌的旧钥匙。末日的门多半已经踹烂了，但总有几扇还认钥匙。'},
