...
for (const t of [1500, 2500, 4000, 6000]) {
  await sleep(t === 1500 ? 1500 : 1000)
  console.log('t=' + t + '  ' + await ev(`JSON.stringify({ root: !!document.getElementById('v4tut'), step: V4Tutorial.step(), closeLog: window.__v4TutCloseLog || null })`))
}
ws.close()
