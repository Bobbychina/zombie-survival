...
console.log(await ev(`(async () => {
  ...
  const t0 = !!document.getElementById('v4tut')
  await new Promise(r => setTimeout(r, 800))
  const t1 = !!document.getElementById('v4tut')
  const html = document.getElementById('v4tut') ? document.getElementById('v4tut').innerHTML.slice(0, 120) : '(none)'
  return JSON.stringify({ 立刻: t0, 800ms后: t1, step: V4Tutorial.step(), isOpen: V4Tutorial.isOpen(), html })
})()`))
ws.close()
